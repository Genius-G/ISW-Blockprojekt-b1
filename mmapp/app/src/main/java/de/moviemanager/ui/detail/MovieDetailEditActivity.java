...
public class MovieDetailEditActivity extends PortrayableDetailEditActivity<Movie> {
    ...
    private DateAttribute<Movie> dueDateAttr;
    private DateAttribute<Movie> watchDateAttr;
    ...
    private void buildWatchDateAttr() {
        watchDateAttr = buildDateAttribute(
    ...
    private void buildDueDateAttr() {
        dueDateAttr = buildDateAttribute(
                R.id.edit_due_date,
                Movie::getDueDate,
                MovieTransformations::changeDueDate
        );
    }
    ...
    private void setDueDateAttr() {
        Date current = dueDateAttr.getContent();
        //Toast.makeText(getApplicationContext(), );
        if (current != null) {
            dueDateAttr.accessDateSelectionView().setMinDate(current);
        } else {
            dueDateAttr.accessDateSelectionView().setMinDate(DateUtils.nowAtMidnight());
        }
    }

    private void setWatchDateAttr() {
        if (dueDateAttr.getContent() != null) {
            watchDateAttr.accessDateSelectionView().setSelectDateEnabled(false);
